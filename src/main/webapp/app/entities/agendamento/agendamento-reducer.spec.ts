...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENDAMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGENDAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGENDAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGENDAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGENDAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGENDAMENTO actions', async () => {
      const expectedActions = [
        {
