    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="dronedeliveryApp.pedido.solicitante">Solicitante</Translate>
          </dt>
          <dd>{pedidoEntity.solicitante ? pedidoEntity.solicitante.id : ''}</dd>
          <dt>
            <Translate contentKey="dronedeliveryApp.pedido.solicitado">Solicitado</Translate>
          </dt>
          <dd>{pedidoEntity.solicitado ? pedidoEntity.solicitado.id : ''}</dd>
          <dt>
