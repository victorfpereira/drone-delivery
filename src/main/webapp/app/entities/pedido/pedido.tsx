          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="dronedeliveryApp.pedido.solicitante">Solicitante</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="dronedeliveryApp.pedido.solicitado">Solicitado</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {pedidoList.map((pedido, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{pedido.solicitante ? <Link to={`/cliente/${pedido.solicitante.id}`}>{pedido.solicitante.id}</Link> : ''}</td>
                  <td>{pedido.solicitado ? <Link to={`/empresa/${pedido.solicitado.id}`}>{pedido.solicitado.id}</Link> : ''}</td>
