...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pedido.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PEDIDO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PEDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PEDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PEDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PEDIDO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PEDIDO actions', async () => {
      const expectedActions = [
        {
