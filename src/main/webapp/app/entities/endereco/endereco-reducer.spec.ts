...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './endereco.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENDERECO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENDERECO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENDERECO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENDERECO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENDERECO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENDERECO actions', async () => {
      const expectedActions = [
        {
