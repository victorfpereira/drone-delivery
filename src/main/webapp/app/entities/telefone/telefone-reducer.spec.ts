...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './telefone.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELEFONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TELEFONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TELEFONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TELEFONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TELEFONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TELEFONE actions', async () => {
      const expectedActions = [
        {
