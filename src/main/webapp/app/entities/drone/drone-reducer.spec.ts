...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './drone.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DRONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DRONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DRONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DRONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DRONE actions', async () => {
      const expectedActions = [
        {
