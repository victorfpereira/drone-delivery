...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './empresa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPRESA_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPRESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPRESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPRESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPRESA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPRESA actions', async () => {
      const expectedActions = [
        {
