...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cliente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTE actions', async () => {
      const expectedActions = [
        {
