...
import br.com.dronedelivery.service.DroneService;
...
/**
 * REST controller for managing {@link br.com.dronedelivery.domain.Drone}.
 */
@RestController
@RequestMapping("/api")
public class DroneResource {
     ...
     */
    @GetMapping("/drones")
    public ResponseEntity<List<DroneDTO>> getAllDrones(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<DroneDTO> getDrone(@PathVariable UUID id) {
