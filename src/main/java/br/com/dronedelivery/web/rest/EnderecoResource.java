...
/**
 * REST controller for managing {@link br.com.dronedelivery.domain.Endereco}.
 */
@RestController
@RequestMapping("/api")
public class EnderecoResource {
    ...
    public ResponseEntity<List<EnderecoDTO>> getAllEnderecos(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
    ...
    public ResponseEntity<EnderecoDTO> getEndereco(@PathVariable UUID id) {
