...
public class Pedido implements Serializable {
    ...
    public Pedido solicitante(Cliente cliente) {
        this.setSolicitante(cliente);
        return this;
    }

    public Empresa getSolicitado() {
        return this.solicitado;
    }

    public void setSolicitado(Empresa empresa) {
        this.solicitado = empresa;
    }

    public Pedido solicitado(Empresa empresa) {
        this.setSolicitado(empresa);
        return this;
    }
